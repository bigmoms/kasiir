...
<body>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <address>
                            <strong class="text-danger">CV. TOKO TES</strong><br />
                            <p style="color: blue;">Jual Beli Elektronik</p>
                        </address>
                    </div>
                </div>
            </div>
    ...
    <script src="{{ asset('adminlte') }}/bootstrap4/js/jquery.js"></script>

    <script src="{{ asset('adminlte') }}/bootstrap4/js/bootstrap.min.js"></script>
    <script>
