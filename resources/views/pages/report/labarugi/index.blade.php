                        ...
                        <div id="totalLabaRugi">
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <td>Penjualan </td>
                                        <td> <span style="float:right" id="sttlpnj"></span></td>
                                    </tr>
                                    <tr>
                                        <td>HPP</td>
                                        <td> <span style="float:right" id="sttlhpp"></span></td>
                                    </tr>
                                    <tr>
                                        <td>Laba Rugi<br></td>
                                        <td> <span style="float:right" id="sttllaba"></span></td>
                                    </tr>
                ...
                <div class="row">
                    <div class="col-md-12 ">
                        <div class="table-responsive">
                            @include('pages.report.labarugi.table')
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('.print').click(function(){
            ...
            let url = `{{ url('report/labarugi/print?tanggal_awal=${tanggal_awal}&tanggal_akhir=${tanggal_akhir}') }}`;
        ...
        function loadTable(tanggal_awal,tanggal_akhir){
            let url =
            `{{ url('report/labarugi/loadTable?tanggal_awal=`+tanggal_awal+`&tanggal_akhir=`+tanggal_akhir+`') }}`;
            const parseResult = new DOMParser().parseFromString(url, "text/html");
            const parsedUrl = parseResult.documentElement.textContent;
