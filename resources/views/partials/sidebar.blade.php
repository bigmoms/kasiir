<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            @if (Auth::user()->level == 'Admin')
            <li
                class="treeview {{ set_active(['kategorijasa.index', 'kategorijasa.create', 'kategorijasa.edit']) }}">
                <a href="#">
                    <i class="fa fa-archive"></i>
                    <span>Jasa</span>
                    <span class="pull-right-container">
                ...
                <ul class="treeview-menu">
                    <li class="{{ set_active(['kategorijasa.index', 'kategorijasa.create', 'kategorijasa.edit']) }}">
                        <a href="{{ route('kategorijasa.index') }}"><i class="fa fa-circle-o"></i> Kategori</a>
                    </li>
                    <li class="{{ set_active(['biaya.index', 'biaya.create', 'biaya.edit']) }}">
                        <a href="{{ route('biaya.index') }}"><i class="fa fa-circle-o"></i> Biaya Jasa</a>
                    </li>
                </ul>
            </li>
        @endif
            ...
            @if (Auth::user()->level == 'Admin' or Auth::user()->level == 'Petugas')
                <li class="{{ set_active(['kasir.index']) }}">
                    <a href="{{ route('kasir.index') }}">
                        <i class="fa fa-th"></i> <span>Kasir Barang</span>
                    </a>
                </li>
                <li class="{{ set_active(['jasa.index']) }}">
                    <a href="{{ route('jasa.index') }}">
                        <i class="fa fa-th"></i><span>Transaksi Jasa</span>
                    </a>
                </li>
            @endif
                        ...
                        <li
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="{{ set_active(['transaksi.penjualan.barang.index']) }}">
                                    <a href="{{ route('transaksi.penjualan.barang.index') }}"><i
                                            class="fa fa-circle-o"></i>
                                        Per Barang</a>
                                </li>
                            </ul>
                        ...
                        <li
                            ...
                            <ul class="treeview-menu">
                                <li
                                    ...
                                    <a href="{{ route('transaksi.return.penjualan.index') }}"><i
                                            class="fa fa-circle-o"></i>
                                        Penjualan</a>
                                </li>
                                <li
                                    class="{{ set_active(['transaksi.return.pembelian.index', 'transaksi.return.pembelian.create']) }}">
                                    <a href="{{ route('transaksi.return.pembelian.index') }}"><i
                                            class="fa fa-circle-o"></i>
                                        Pembelian</a>
                                </li>
                            </ul>
            ...
            @if (Auth::user()->level == 'Admin' or Auth::user()->level == 'Manager')
                <li
                    ...
                    <ul class="treeview-menu">
                        <li
                            class="treeview {{ set_active(['report.penjualan.periode', 'report.penjualan.barang']) }}">
                            <a href="#"><i class="fa fa-shopping-bag"></i> Penjualan
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                        ...
                        <li class="{{ set_active(['report.jasa.periode']) }}">
                            <a href="{{ route('report.jasa.periode') }}"><i class="fa fa-shopping-cart"></i>
                                Transaksi Jasa</a>
                        </li>
                        ...
                        <li class="{{ set_active(['report.hutang.index']) }}">
                            <a href="{{ route('report.hutang.index') }}"><i class="fa fa-calendar-minus-o"></i>
                                Hutang</a>
                        </li>
                        ...
                        <li class="{{ set_active(['report.labarugi.index']) }}">
                            <a href="{{ route('report.labarugi.index') }}"><i class="fa fa-line-chart"></i> Laba
                                Rugi</a>
                        </li>
                        <li class="{{ set_active(['report.penggajian.index']) }}">
                            <a href="{{ route('report.penggajian.index') }}"><i class="fa fa-user"></i>
                                Penggajian</a>
                        </li>
